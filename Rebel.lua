...
game.Players.LocalPlayer.CameraMode = "LockFirstPerson"
 ...
 if not RunService:IsStudio() then
	 ScreenGui = game:GetObjects("rbxassetid://13510552309")[1] -- THE COMMAND BAR | FEEL FREE TO CHANGE THE LOOK
 else
...
-- [[ OPEN THE COMMAND BAR ]] -- 
 mouse.KeyDown:Connect(function(k)
	 if k:lower() == opt.prefix then
		 ...
		 for i=1,10 do
			 wait(0.000051)
		  game.Players.LocalPlayer.PlayerGui.boomb.Frame.BackgroundTransparency -= 0.04
			 end
	 end
 end)
